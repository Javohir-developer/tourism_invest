...
CSS;
    ...
    private function menuItemSetting(){
        ...
        echo Html::submitButton(__('Menu Update'),['class' => 'btn btn-primary']);
        echo Html::a(__('Menu Remove'),'#menuitem',['class' => 'btn btn-danger pull-right',
            'title'        => 'delete',
            'data-query' => 'delete',
            ...
            'data-query-confirm' => __('Are you sure?'),
